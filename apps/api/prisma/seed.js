...
async function main() {
  ...
  // for (let organizer of dataEventOrganizer) {
  //   const hashedPassword = await hashPassword(organizer.password);

  //   await prisma.eventOrganizer.create({
  //     data: {
  //       organizerName: organizer.organizerName,
  //       ownerName: organizer.ownerName,
  //       email: organizer.email,
  //       password: hashedPassword,
  //       role: organizer.role,
  //       phoneNumber: organizer.phoneNumber,
  //       identityNumber: organizer.identityNumber,
  ...
  // for (let i = 1; i < categoryEvent.length; i++) {
  //   await prisma.category.create({
  //     data: {
  //       id: categoryEvent[i].id,
  //       Category: categoryEvent[i].Category
  //     }
  //   })
  // }
}
...
//   const categories = ['Music', 'Expo', 'Sports', 'Comedy'];
